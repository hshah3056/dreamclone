            ...
            <nav class="navbar navbar-expand-lg fixed-top navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ route('web-service') }}" class="nav-item nav-link active">Services</a>
                    </div>
        ...
        <div class="container-fluid py-5 overflow-hidden">
            <div class="container">
                ...
                <div class="row g-5 align-items-center mb-5 pb-5 border-bottom border-light">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="rounded shadow-lg overflow-hidden">
                            <img src="assets/img/static-website.png" class="img-fluid w-100" alt="Static Web Application Development" title="Static Web Development">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 align-items-center mb-5 pb-5 border-bottom border-light">
                    <div class="col-lg-6 order-2 order-lg-1 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="rounded overflow-hidden">
                            <img src="assets/img/dynamic-web.png" class="img-fluid w-100" alt="Dynamic Web Application Development" title="Dynamic Web Application Development">
                        </div>
                    </div>
                ...
                <div class="row g-5 align-items-center mb-5 pb-5 border-bottom border-light">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="rounded overflow-hidden">
                            <img src="assets/img/digital-marketing.png" class="img-fluid w-100" alt="Digital Marketing Services" title="Digital Marketing Services">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 align-items-center mb-5 pb-5 border-bottom border-light">
                    <div class="col-lg-6 order-2 order-lg-1 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="rounded overflow-hidden">
                            <img src="assets/img/ecommerce.png" class="img-fluid w-100" alt="Ecommerce Website Development" title="Ecommerce Website Development">
                        </div>
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2 wow fadeInRight" data-wow-delay="0.3s">
                ...
                <div class="row g-5 align-items-center mb-5 pb-5 border-bottom border-light">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="rounded shadow-lg overflow-hidden">
                            <img src="assets/img/ui-ux-design.jpeg" class="img-fluid w-100" alt="UI/UX Design Services" title="Ecommerce Website Development">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 order-2 order-lg-1 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="rounded overflow-hidden">
                            <img src="assets/img/server-deployment.png" class="img-fluid w-100" alt="Server Deployment Services" title="Ecommerce Website Development">
                        </div>
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2 wow fadeInRight" data-wow-delay="0.3s">
